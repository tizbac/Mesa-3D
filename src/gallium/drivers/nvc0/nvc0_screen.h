...
#define NVE4_PM_QUERY_METRIC_MP_OCCUPANCY       33
#define NVE4_PM_QUERY_METRIC_MP_EFFICIENCY      34
#define NVE4_PM_QUERY_METRIC_INST_REPLAY_OHEAD  35
/*
...
#define NVC0_QUERY_DRV_STAT_COUNT  27
